    ...
    <div class="container">
        ...
        <form action="registrationHandelar.php" method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="firstName" name="firstName" required value="<?php echo htmlspecialchars( $old_data['firstName'] ?? '' ); ?>">
            </div>
            <div class="mb-3">
                <label for="lastName" class="form-label">Last Name</label>
                <input type="text" class="form-control" id="lastName" name="lastName" required value="<?php echo htmlspecialchars($old_data['lastName'] ?? ''); ?>">
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" id="email" name="email" required value="<?php echo htmlspecialchars($old_data['email'] ?? ''); ?>">
            </div>
            <div class="mb-3">
                <label for="address" class="form-label">Address</label>
                <textarea class="form-control" id="address" name="address" rows="4" required value="<?php echo htmlspecialchars($old_data['address'] ?? ''); ?>"></textarea>
            </div>
            <div class="mb-3">
                ...
                <select class="form-select" id="country" name="country" required>
                    ...
                    <option value="Canada" <?php echo (isset($old_data['country']) && $old_data['country'] == 'Canada') ? 'selected' : ''; ?>>Canada</option>
                    <option value="UK" <?php echo (isset($old_data['country']) && $old_data['country'] == 'UK') ? 'selected' : ''; ?>>United Kingdom</option>
            ...
            <div class="mb-3">
                ...
                <div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender" id="genderMale" value="Male" required <?php echo (isset($old_data['gender']) && $old_data['gender'] == 'Male') ? 'checked' : ''; ?>>
                        <label class="form-check-label" for="genderMale">Male</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender" id="genderFemale" value="Female" required  required <?php echo (isset($old_data['gender']) && $old_data['gender'] == 'Female') ? 'checked' : ''; ?>>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="skills[]" id="skillPHP" value="PHP" <?php echo (isset($old_data['skills']) && in_array('PHP', $old_data['skills'])) ? 'checked' : ''; ?>>
                            <label class="form-check-label" for="skillPHP">PHP</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="skills[]" id="skillMySQL" value="MySQL" <?php echo (isset($old_data['skills']) && in_array('MySQL', $old_data['skills'])) ? 'checked' : ''; ?>>
                            <label class="form-check-label" for="skillMySQL">MySQL</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="skills[]" id="skillJ2SE" value="J2SE"<?php echo (isset($old_data['skills']) && in_array('J2SE', $old_data['skills'])) ? 'checked' : ''; ?>>
                            <label class="form-check-label" for="skillJ2SE">J2SE</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="skills[]" id="skillPostgreSQL" value="PostgreSQL" <?php echo (isset($old_data['skills']) && in_array('PostgreSQL', $old_data['skills'])) ? 'checked' : ''; ?>>
